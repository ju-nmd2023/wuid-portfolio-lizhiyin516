        ...
        const btn  = document.getElementById("actAnima");//get the elements from html
        btn.addEventListener("click",function(){//add an event listener
            alert('Thanks for question!');//take place of onclick
            const anima = document.getElementById("anima");//get another element which let the pic move
